"""
Django settings for GardeningCareServicesApp project.
...
DEBUG = os.getenv('DEBUG', config('DEBUG')) == "False"

ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', config('ALLOWED_HOSTS', default='')).split(',')

CSRF_TRUSTED_ORIGINS = [
    os.getenv('CSRF_TRUSTED_ORIGINS', config('CSRF_TRUSTED_ORIGINS', []))
]
...
ROOT_URLCONF = 'GardeningCareServicesApp.urls'
